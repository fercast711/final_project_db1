    ...
    return (
        <div className="fixed inset-0 overflow-y-auto min-h-screen flex items-center justify-center " >
            <div className=" max-w-xl p-6 rounded-lg shadow bg-gray-800 border-gray-700 min-w-[576px]">
                ...
                {(signUp && typeInsertion === "Client") && (<FormClient dispatch={dispatch} setSignUp={setSignUp} />)}
                {(signUp && typeInsertion === "Agent") && (<FormAgent dispatch={dispatch} setSignUp={setSignUp} />)}
                {logIn && <FormLogIn dispatch={dispatch} setLogIn={setLogIn}/>}
            </div>
